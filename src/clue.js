...
function pickMystery() {
    ...
    objectRandom.suspect = selectRandom(suspectsArray)
    objectRandom.room = selectRandom(roomsArray)
    objectRandom.weapon = selectRandom(weaponsArray)
...
function revealMystery(objectRandom) {
    ...
    console.log(`${objectRandom.suspect.firstName} ${objectRandom.suspect.lastName} killed Mr. Boddy using the ${objectRandom.weapon.name} in the ${objectRandom.room.name}!`)
